...
class CGraphics_Wii : public IEngineGraphics
{
protected:
	...
	void ReorderPixels(CTexture* tex, const void* data, int srcWidth, int srcHeight, int OriginX, int OriginY, int RowWidth);
